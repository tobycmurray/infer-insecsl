...
let insecsl_check_insecure ~(insecsl_sats:(AbductiveDomain.Summary.t,'a) result sat_unsat_t list ) ~insecsl_trace callee_proc_name call_location astate =
...
let apply_summary path ~is_isl_error_prepost ~insecsl_sats ~insecsl_trace callee_proc_name call_location ~callee_summary
